...
export default function Home() {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/20 via-primary/10 to-background px-4 py-20 md:py-32 text-foreground border-b border-border">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-primary/30 via-transparent to-primary/10 dark:from-primary/20 dark:to-transparent" />
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          >
            <Badge variant="outline" className="mb-4 border-primary/30 bg-primary/10 text-foreground backdrop-blur-sm">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {["Villa", "Apartment", "House", "Penthouse"].map((t) => (
                <button
                  ...
                  className="rounded-full border border-border bg-background/50 dark:bg-background/10 px-3 py-1 text-xs font-medium text-foreground backdrop-blur-sm transition-colors hover:bg-background/70 dark:hover:bg-background/20"
                >
                  {t}
                </button>
              ))}
          ...
          >
            {HERO_STATS.map((stat) => (
              <div key={stat.label} className="rounded-xl bg-background/50 dark:bg-background/10 p-4 backdrop-blur-sm border border-border">
